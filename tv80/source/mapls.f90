...
!
!  synopsis     call mapls (xleft,xright, ybot,ytop)
!               call mapls (xleft,xright, ybot,ytop, xmin,xmax, ymin,ymax)
!
...
!               the last argument to set.  A 3 will specify logorithmic x
!               and linear y mapping.
!
!*************************************************************************
 
!=======================================================================
! 12/28/2001 ler pppl - change subroutine parameters from single
