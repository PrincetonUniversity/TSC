...
!
!  synopsis     call points (x,y,num)
!               call points (x,y,num,incx)
!               call points (x,y,num,incx,incy)
!               call points (x,y,num,incx,incy,  0.0)
!               call points (x,y,num,incx,incy,  0.0, 0.0)
!               call points (x,y,num,0   ,incy, delx)
!               call points (x,y,num,0   ,0   , delx,dely)
!               call points (x,y,num,incx,0   ,  0.0,dely)
!
!               real x,y                Points
...
!
!  description  Draws a series of points.  The default value for incx and
!               incy is 1.  If incx or incy is 0, then we generate the
!               succesive points by adding delx or dely to the previous
!               points.
!
!*************************************************************************
