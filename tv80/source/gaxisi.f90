...
!**************************************************************************
!
!  gaxisi.F - axis labeling routine
!
!  contents    gaxisi - axis parameter calculations
...
! idecl:  explicitize implicit INTEGER declarations:
      ...
      INTEGER jside,ierr
      INTEGER ioldhz,ioldvt,j,iabs,jnum,jmod,jfact,jnew,jdiv,jdif
      INTEGER j20,j10,j1
!============
...
!      equivalence (bpp, npp)
!
!      equivalence (bdiv(1), ndiv(1))
!
!      equivalence (bvstr(1), nstr(1))
!
!      equivalence (gq, jq)
!
...
! jump according to the type of labeling to be done
      if (kdiv) 10, 20, 30
!
! The idivin array contains iabs(kdiv) elements which are to be plotted
! at even intervals along the axis.
!
   10 kdiv = iabs(kdiv)
!
