...
!**********************************************************************
!
!  multmat  -  Multiply the transformation matrix by another matrix
!
!  synopsis     call multmat (matrix)
!               real matrix(3,3)        Matrix to multiply by
!
!  description  Combines the passed matrix into the transformation
!               matrix by multiplying the two.
!
!**********************************************************************
