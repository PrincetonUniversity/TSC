...
!  rot2d  -  Set rotation
!
!  synopsis     call rot2d (angle)
!               real angle      angle of rotation about the center
!
!  description  Sets variable to let the library know that it must
!               do the rotation and sets the angle in radians.  The
!               user specifies the angle in degrees.
!
!**********************************************************************
...
! The angle of text changes with the rotation.
