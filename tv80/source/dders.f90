...
!
!  synopsis     call dders (iflag)
!
!               integer iflag                   Clip indicator
!
!  description  If iflag is -1, the clipping to the view port is turned on.
!               If iflag is 0 (default), the clipping is turned off.  The
!               original version of tv80lib had +1 which indicated no
!               clipping at all.
!
!*************************************************************************
...
! Flush buffers that are assuming current clipping mode
 
        call tgflush
 
! If -1 or 0 then turn clipping on, if 1 then turn clipping off.
