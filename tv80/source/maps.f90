...
!*************************************************************************
!
!  maps  -  Define an x and y axes in linear coordinates and draw ticks
!
!  synopsis     call maps (xleft,xright, ybot,ytop)
!               call maps (xleft,xright, ybot,ytop, xmin,xmax, ymin,ymax)
!
