...
!*************************************************************************
!
!  mapg  -  Define an x and y axes in linear coordinates and draw grid
!
!  synopsis     call mapg (xleft,xright, ybot,ytop)
!               call mapg (xleft,xright, ybot,ytop, xmin,xmax, ymin,ymax)
!
