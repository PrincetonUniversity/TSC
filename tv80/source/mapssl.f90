...
!*************************************************************************
!
!  mapssl  -  Define an x,y axes in linear-log coordinates and draw ticks
!
!  synopsis     call mapssl (xleft,xright, ybot,ytop)
!               call mapssl (xleft,xright,ybot,ytop,xmin,xmax,ymin,ymax)
!
