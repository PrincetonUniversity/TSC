...
!*************************************************************************
!
!  setch  - set character attributes for absolute grid
!
!  synopsis     call setch (x,y)
!               call setch (x,y,icase)
!               call setch (x,y,icase,isize)
!               call setch (x,y,icase,isize,iorient)
!               call setch (x,y,icase,isize,iorient,ifont)
!
!               real x,y        Position
...
!
!  description  x,y will be the position in absolute coordinates.
!
!*************************************************************************
