...
!
!  synopsis     call pointc (ch,x,y,num)
!               call pointc (ch,x,y,num,incx)
!               call pointc (ch,x,y,num,incx,incy)
!               call pointc (ch,x,y,num,incx,incy,  0.0)
!               call pointc (ch,x,y,num,incx,incy,  0.0, 0.0)
!               call pointc (ch,x,y,num,0   ,incy, delx)
!               call pointc (ch,x,y,num,0   ,0   , delx,dely)
!               call pointc (ch,x,y,num,incx,0   ,  0.0,dely)
!
