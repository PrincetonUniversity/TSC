...
!  synopsis     call frame ()
!               call frame (nframe)
!               integer nframe          Number of empty frames
!
!  description  Buffers are flushed and empty frames are inserted if
!        requested.  max(nframe,1) frame advances will be done.
!
!*************************************************************************
...
! if nframe was passed to this routine and it was positive, then the
! number of frames will be inserted.
