...
!*************************************************************************
!
!  tgisfont  -  test if a font is valid
!
!  synopsis    logical tgisfont
!        if (tgisfont (ifont)) newfont = ifont
!               integer ifont       Font number to test
!
!  description  Checks to see if a font is valid.  Returns .FALSE. if it
!        isn't and .TRUE. if it is.  This routine is dependent
!        upon a specific implementation of GKS.
!
!*************************************************************************
