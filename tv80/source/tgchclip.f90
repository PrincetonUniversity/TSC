...
!*************************************************************************
!
!  tgchclip  -  Turn character clipping on or off
!
!  synopsis    call tgchclip (iclip)
!        integer iclip     Clipping flag
!
!  description    All character output is funneled through GTEXT.  When a
!        user calls GTEXT the characters are never clipped, when
!        internal routines need character output, it may be
!        necessary to turn the clipping on temporarily.  TGCHCLIP
!        will turn the clipping on or off depending on whether
!        iclip is 1 or 0 respectively.
!
!*************************************************************************
