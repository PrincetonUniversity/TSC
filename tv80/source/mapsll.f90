...
!*************************************************************************
!
!  mapsll  -  Define an x and y axes in log coordinates and draw ticks
!
!  synopsis     call mapsll (xleft,xright, ybot,ytop)
!               call mapsll (xleft,xright,ybot,ytop,xmin,xmax,ymin,ymax)
!
