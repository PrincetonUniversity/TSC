...
!
!  synopsis     call plotea ()
!
!  description  Flushes TV80GKS buffers.  Under TV80LIB, this routine had
!        a single integer argument which was called 'iempty'. The
!        argument was not used so it was removed.
!
!*************************************************************************
