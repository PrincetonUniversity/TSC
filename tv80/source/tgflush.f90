...
!
!  synopsis     call tgflush
!
!  description  Creates a polyline from the line buffer.  This routine
!               was designed to be called only from tv80lib.  To do a
!               flush, the user should call plotea.
!
!*************************************************************************
