...
!*************************************************************************
!
!  mapgll  -  Define an x and y axes in log coordinates and draw grid
!
!  synopsis     call mapgll (xleft,xright, ybot,ytop)
!               call mapgll (xleft,xright,ybot,ytop,xmin,xmax,ymin,ymax)
!
