...
!
!  synopsis     call center (cx,cy)
!               real cx,cy      x,y of the center
!
!  description  Sets variable to let the library know that it must
!               do the transformation and sets the center.  cx and cy
!               are in the users coordinate system.  They are converted
!               to normalized coordinated when the transformation
!               matrix is created in catmat.
!
!**********************************************************************
