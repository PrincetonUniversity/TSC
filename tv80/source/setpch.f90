...
!
!  synopsis     call setpch (icase)
!               call setpch (icase,isize)
!               call setpch (icase,isize,itype)
!               call setpch (icase,isize,itype,kspace)
!
!
!  description  Sets the parameters depended upon by pointc and tracec.
!
!*************************************************************************
...
! idecl:  explicitize implicit INTEGER declarations:
      ...
      INTEGER isize,itype,kspace,icase
!============
        logical tgisfont
