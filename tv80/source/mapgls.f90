...
!*************************************************************************
!
!  mapgls  -  Define an x,y axes in log-linear coordinates and draw grid
!
!  synopsis     call mapgls (xleft,xright, ybot,ytop)
!               call mapgls (xleft,xright,ybot,ytop,xmin,xmax,ymin,ymax)
!
