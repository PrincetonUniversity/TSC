...
!*************************************************************************
!
!  mapsls  -  Define an x,y axes in log-linear coordinates and draw ticks
!
!  synopsis     call mapsls (xleft,xright, ybot,ytop)
!               call mapsls (xleft,xright,ybot,ytop,xmin,xmax,ymin,ymax)
!
