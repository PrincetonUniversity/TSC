!#include "f77_dcomplx.h"
      subroutine svd2(mn,m,n,amat,bvec,sigma,matu,matv,xvec,ierr,        &  
     & relerr,tau,wmax,wmin,wrat,rsq,rmsnorm,null)
!
!.......................................................................
!
!
!**********************************************************************
!     NOTE: szrms and zzrms and the format statement 9058
!
!
...
!
!
!c      dimension amat(mn,mn),sigma(mn),uu(mn,mn),vv(mn,mn),rv1(mn),
!c     +xvec(mn),bvec(mn)
!============
! idecl:  explicitize implicit INTEGER declarations:
      INTEGER m,n,matu,matv,ierr,null,mn,i,j,l,k,ii,kk,k1,its,ll,l1
      INTEGER i1
!============
! idecl:  explicitize implicit REAL declarations:
      REAL*8 amat,bvec,sigma,xvec,relerr,tau,wmax,wmin,wrat,rsq
      REAL*8 rmsnorm,uu,vv,rv1,g,scale,anorm,s,f,h,c,y,z,x
      REAL*8 AREAL
!============
      dimension amat(mn,*),sigma(*),uu(50,50),vv(50,50),rv1(50),         &  
     &xvec(mn),bvec(*)
!    &xvec(*),bvec(*)
!============      
!
