...
!     .......... for j=l step -1 until 1 do -- ..........
  100 do 120 jj = 1, l
         ...
         do 110 i = 1, l
            if (i .eq. j) go to 110
            if (ar(j,i) .ne. 0.000_R8.or. ai(j,i) .ne. 0.000_R8) go to   &  
     & 120
  110    continue
...
!                and push them left ..........
  ...
  140 do 170 j = k, l
         ...
         do 150 i = k, l
            if (i .eq. j) go to 150
            if (ar(i,j) .ne. 0.000_R8.or. ai(i,j) .ne. 0.000_R8) go to   &  
     & 170
  150    continue
...
!     .......... guard against zero c or r due to underflow ..........
         if (c .eq. 0.000_R8.or. r .eq. 0.000_R8) go to 270
         g = r / radix
         f = 1.000_R8
         s = c + r
