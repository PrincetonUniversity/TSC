...
!============
  ...
  200 cplot(n) = 0._R8
      ...
      uplot2(indx) = uplot2(indx) + pling5(i,j)/udst*tpi*fac
      eplot2(indx) = eplot2(indx) + etay(i,j)*ajp2(i,j)/udst*tpi*fac
      bplot2(indx) = bplot2(indx) - gs(i,j)*ajp4(i,j)/udst*tpi*fac
...
!
  ...
  500 continue
      ...
      write(s100,1002)
      call gtext(s100,80,0)
 1001 format(" pol f ohms law  N =",i6)
 1002 format(1x,/," u ...V.Grad psi",/,                                  &  
     &       " E ...eta*J     ",/,                                       &  
     &       " H ...Hyper  res" ,/,                                      &  
     &       " T ...Total" )
